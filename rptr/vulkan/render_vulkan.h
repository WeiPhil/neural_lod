...
struct RenderVulkan : RenderBackend {
    ...
    vkrt::Texture2D debug_texture_buffer = nullptr;
    ...
    VkSampler debug_texture_sampler = VK_NULL_HANDLE;
    ...
    VkDescriptorSetLayout debug_texture_desc_layout = VK_NULL_HANDLE;

    VkDescriptorPool texture_desc_pool = VK_NULL_HANDLE;
    VkDescriptorPool material_texture_desc_pool = VK_NULL_HANDLE;
    VkDescriptorPool debug_texture_desc_pool = VK_NULL_HANDLE;
    ...
    VkDescriptorSet debug_texture_desc_set = VK_NULL_HANDLE;
